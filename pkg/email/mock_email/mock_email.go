...
//
//	mockgen -source=pkg/email/email.go -destination=pkg/email/mock_email/mock_email.go -package=mock_email
//
...
// OfferCreated mocks base method.
func (m *MockMailerService) OfferCreated(offerID uint, userMail string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OfferCreated", offerID, userMail)
}

// OfferCreated indicates an expected call of OfferCreated.
func (mr *MockMailerServiceMockRecorder) OfferCreated(offerID, userMail any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OfferCreated", reflect.TypeOf((*MockMailerService)(nil).OfferCreated), offerID, userMail)
}
